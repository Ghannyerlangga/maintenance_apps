...
class ListOutConsumable extends StatefulWidget {
  @override
  _ListOutConsumableState createState() => _ListOutConsumableState();
}

class _ListOutConsumableState extends State<ListOutConsumable> {
  Stream<QuerySnapshot> dataOutConsumable;
  ...
  @override
  void initState() {
    dataOutConsumable = database.getOutConsumable();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Background(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Daftar Out Consumable'.toUpperCase()),
        actions: [
          Padding(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return TambahOutConsumable(isTambah: true);
                  }));
                }),
          )
        ],
                  ...
                  children: <Widget>[
                    ...
                    FlatButton.icon(
                        onPressed: () {
                          ...
                          print(snap.data);
                          outConsumable = OutConsumable.fromSnapshot(snap);
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) {
                              return TambahOutConsumable(
                                isTambah: false,
                                outConsumable: outConsumable,
                              );
                            },
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              FlatButton(
                  onPressed: () {
                    database.deleteOutConsumable(docId);
