...
class ListPeminjamanMesin extends StatefulWidget {
  @override
  _ListPeminjamanMesinState createState() => _ListPeminjamanMesinState();
}

class _ListPeminjamanMesinState extends State<ListPeminjamanMesin> {
  final CollectionReference peminjamanMesinCollection =
      Firestore.instance.collection('peminjamanmesin');

  Stream<QuerySnapshot> dataSparePart;
  List<DocumentSnapshot> dataList;

  PeminjamanMesin peminjamanMesin;
  ...
  Stream<QuerySnapshot> getPeminjamanMesin() {
  ...
  Widget build(BuildContext context) {
    return Background(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Daftar Peminjaman Mesin'.toUpperCase()),
        actions: [
          Padding(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return TambahPeminjamanMesin(isTambah: true);
                  }));
                }),
          )
        ],
      ...
      body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (builder, snapshot) {
            ...
            return _tablePeminjamanMesin(dataList);
          }),
    );
  }
  ...
  Widget _tablePeminjamanMesin(List<DocumentSnapshot> documents) {
    return Container(
      child: HorizontalDataTable(
        leftHandSideColumnWidth: 30,
        rightHandSideColumnWidth: 1430,
        isFixedHeader: true,
        ...
        rightSideItemBuilder: (context, index) {
          return Row(
            children: <Widget>[
              ...
              _tabelCell(documents[index]['tanggal_pinjam'].toString()),
              _tabelCell(
                  documents[index]['tanggal_rencana_kembali'].toString()),
              _tabelCell(documents[index]['tanggal_kembali'].toString()),
              _tabelCell(documents[index]['pengguna'].toString()),
              _tabelCell(documents[index]['no_hp'].toString()),
                  ...
                  children: <Widget>[
                    ...
                    FlatButton.icon(
                        onPressed: () {
                          ...
                          print(snap.data);
                          peminjamanMesin = PeminjamanMesin.fromSnapshot(snap);
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) {
                              return TambahPeminjamanMesin(
                                isTambah: false,
                                peminjamanMesin: peminjamanMesin,
                              );
                            },
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('Nama Alat', 100.0),
      _getTitleItemWidget('Tipe', 100.0),
      _getTitleItemWidget('Kapasitas', 100.0),
      _getTitleItemWidget('Jumlah', 100.0),
      _getTitleItemWidget('Tanggal Peminjaman', 100.0),
      _getTitleItemWidget('Tanggal Rencana Kembali', 100.0),
      _getTitleItemWidget('Tanggal Kembali', 100.0),
      _getTitleItemWidget('Pengguna', 100.0),
      _getTitleItemWidget('No HP', 100.0),
