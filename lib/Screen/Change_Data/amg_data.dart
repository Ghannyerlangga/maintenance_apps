...
import 'amg/c_month.dart';
import 'amg/c_annual.dart';
import 'amg/c_plasma.dart';
import 'package:maintenance_apps/shared/loading.dart';

class AmgData extends StatefulWidget {
  final String mesin;
  AmgData({this.mesin});
  @override
  _AmgDataState createState() => _AmgDataState();
}

class _AmgDataState extends State<AmgData> {
